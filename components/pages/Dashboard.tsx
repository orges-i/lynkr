...
const SidebarItem: React.FC<{
  ...
  >
    <Icon
      className={`w-5 h-5 ${
        active ? "text-background" : "text-secondary group-hover:text-primary"
      }`}
    />
    <span>{label}</span>
  </button>
...
const PhonePreview: React.FC<{
  ...
  updatedLabel?: string;
  selectedLinkAnimation?: "none" | "glow";
}> = ({ links, config, contacts, updatedLabel, selectedLinkAnimation }) => {
  ...
  let textColorClass = isLight
    ? "text-zinc-900"
    : "text-white shadow-black/50 drop-shadow-md";
  let customTextStyle = {};
  ...
  if (config.buttonShadow === "soft") {
    ...
    btnClasses +=
      "border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] ";
    if (isDarkTheme)
      btnClasses +=
        "border-white shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,1)] ";
  }

  // Custom Theme Background Handling
  const customStyle =
    config.theme === "custom" && (config as any).customThemeUrl
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`p-6 flex flex-col items-center -mt-12 relative z-10 ${textColorClass}`}
        >
          ...
          {config.showUpdatedChip && (
            <div
              className={`text-[11px] font-medium mb-3 ${
                isLight ? "text-black/50" : "text-white/70"
              }`}
            ...
            (contacts.phone ||
              ...
              <div className="w-full mb-4">
                <div className="flex items-center justify-center gap-3">
                  ...
                  {contacts.linkedin && (
                    <a
                      href={normalizeLinkedInUrl(contacts.linkedin)}
                      target="_blank"
                      rel="noreferrer"
                      className={`w-10 h-10 rounded-full flex items-center justify-center hover:scale-105 transition-all ${
                        forceLightMode
        ...
        {config.showBrandTag && (
          <div className="mt-auto pt-4 flex justify-center pb-6">
          ...
          <div className="flex flex-wrap items-center justify-between pt-3 border-t border-border/50 gap-2">
            <div className="flex gap-2">
              <div className="flex items-center gap-1">
                <button
                  onClick={() =>
                    document.getElementById(`thumb-upload-${link.id}`)?.click()
                  }
                  ...
                  title={
                    link.thumbnail_url ? "Change Thumbnail" : "Add Thumbnail"
                  }
                >
                ...
                {link.thumbnail_url && (
                  <button
                    onClick={() =>
                      onUpdate(link.id, { thumbnail_url: null } as any)
                    }
              ...
              <button
                onClick={() =>
                  onUpdate(link.id, { show_icon: !(link.show_icon !== false) })
                }
    ...
    return (
      <div className="max-w-2xl mx-auto w-full animate-slide-up pb-24 space-y-4">
        ...
        {[...Array(3)].map((_, i) => (
          <div
            key={i}
            className="h-32 rounded-2xl bg-surfaceHighlight animate-pulse"
          />
        ))}
      </div>
    );
      ...
      <div className="mb-8 space-y-3">
        <div>
          ...
          <p className="text-secondary">
            Manage what shows up on your profile.
          </p>
        </div>
      ...
      <div className="mb-6 flex flex-col gap-3">
        ...
        >
          <div
            ...
            } translate-x-[-120%] group-hover:animate-shimmer pointer-events-none`}
          ></div>
...
const AppearanceView: React.FC<{
  ...
  onUpdate: (
    updates:
      ...
      | { avatar?: File; coverImage?: File; customTheme?: File }
  ) => void;
  loading?: boolean;
  updatedLabel?: string;
  selectedLinkAnimation?: "none" | "glow";
  onSelectLinkAnimation?: (animation: "none" | "glow") => void;
}> = ({
  config,
  onUpdate,
  loading,
  updatedLabel: _updatedLabel,
  selectedLinkAnimation,
  onSelectLinkAnimation,
}) => {
  if (loading) {
    return (
      <div className="max-w-2xl mx-auto w-full animate-slide-up space-y-6 pb-24">
        {[...Array(4)].map((_, i) => (
          <div
            key={i}
            className="h-24 rounded-2xl bg-surfaceHighlight animate-pulse"
          />
        ))}
      </div>
    );
    ...
    <div className="max-w-2xl mx-auto w-full animate-slide-up space-y-12 pb-24">
            ...
            <div className="flex gap-3 mt-3">
              ...
              {config.coverImage && (
                <Button
                  ...
                  onClick={() => onUpdate({ coverImage: "" as any })}
                >
                  Remove
                </Button>
              )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            {[
              ...
              <button
                ...
                onClick={() =>
                  onUpdate({
                    avatarFrame: frame.id as ProfileConfig["avatarFrame"],
                  })
                }
                className={`flex items-center gap-3 p-3 rounded-xl border transition-all text-left ${
                  config.avatarFrame === frame.id
                    ? "border-primary bg-primary/5"
                    : "border-border hover:border-primary/40 hover:bg-surfaceHighlight"
                }`}
              >
                <div
          ...
          {Object.keys(themes)
            ...
            .map((themeKey) => (
              <div
                ...
                className={`cursor-pointer group relative rounded-xl border-2 overflow-hidden transition-all ${
            ...
            <div
              ...
              style={
                config.customThemeUrl
                  ? {
                      backgroundImage: `url(${config.customThemeUrl})`,
        ...
        <div className="bg-surface border border-border rounded-2xl p-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-secondary">
              Display the LYNKR logo at the bottom of your page.
            </p>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
      ...
      <section className="space-y-4">
        ...
        <div className="bg-surface border border-border rounded-2xl p-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-secondary">
              Display the “Updated … ago” chip below your username.
            </p>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
              ...
              onChange={() =>
                onUpdate({ showUpdatedChip: !config.showUpdatedChip })
              }
              className="sr-only peer"
      ...
      <section className="space-y-4">
        ...
        <div className="bg-surface border border-border rounded-2xl p-6">
          <p className="text-xs text-secondary mb-4">
            Choose a link animation preview; off by default.
          </p>
          <div className="flex flex-wrap gap-3">
            {[
              ...
              <button
                key={anim.id}
                onClick={() => {
                  if (onSelectLinkAnimation) {
                    onSelectLinkAnimation(anim.id as any);
                  }
                  onUpdate({
                    linkAnimation: anim.id as ProfileConfig["linkAnimation"],
                  });
                }}
                className={`px-4 py-3 rounded-xl border text-sm font-medium transition-all ${
                  (selectedLinkAnimation || config.linkAnimation) === anim.id
                    ? "border-primary bg-primary/5 text-primary"
                    : "border-border hover:border-primary/40 text-secondary"
                }`}
              >
                {anim.label}
              </button>
        ...
        <div className="flex gap-4">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium border-2 transition-all ${
              !config.fontColor || config.fontColor === "auto"
          ...
          <button
            ...
            className={`w-10 h-10 rounded-full border-2 transition-all flex items-center justify-center bg-white shadow-md ${
          ...
          <button
            ...
            className={`w-10 h-10 rounded-full border-2 transition-all flex items-center justify-center bg-black shadow-md ${
      ...
      <section className="space-y-4">
        ...
        <div className="bg-surface border border-border rounded-2xl p-6 space-y-8">
          {/* Shape */}
          <div>
            <label className="text-xs font-semibold text-secondary uppercase mb-3 block">
              Shape
            </label>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {Object.keys(buttonStyles).map((style) => (
                <button
                  ...
                  className={`p-4 border rounded-lg hover:bg-surfaceHighlight transition-all flex flex-col items-center gap-2 ${
            ...
            <div className="flex flex-wrap gap-4">
              {["solid", "outline", "ghost"].map((fill) => (
                <button
                  ...
                  className={`px-6 py-3 rounded-xl border capitalize text-sm font-medium transition-all ${
                    config.buttonFill === fill
            ...
            {[
              ...
              <button
                ...
                className={`p-4 border rounded-xl text-center transition-all ${
                  config.font === font.id
                    ? "border-primary bg-primary/5"
                    : "border-border hover:bg-surfaceHighlight"
                }`}
              >
                <span className={`text-2xl font-bold block mb-2 ${font.class}`}>
                  Aa
                </span>
  ...
  return (
    <div className="max-w-4xl mx-auto w-full h-[60vh] flex flex-col items-center justify-center animate-slide-up text-center space-y-4">
      ...
      <p className="text-secondary max-w-sm">
        We're building advanced tracking for your links, referral sources, and
        geographic data. Stay tuned!
      </p>
      <div className="pt-4">
      ...
      <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  type="text"
                  defaultValue={
                    profileConfig.username || user?.user_metadata?.username
                  }
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setLocalSeo((prev) => ({ ...prev, title: e.target.value }))
                  }
        ...
        <div className="bg-red-500/5 border border-red-500/20 rounded-2xl overflow-hidden">
          ...
          <div className="p-6 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
            ...
            <Button
              variant="ghost"
              className="text-red-500 hover:bg-red-500/10 hover:text-red-600 whitespace-nowrap"
            >
              Delete Account
            </Button>
          </div>
...
const Dashboard: React.FC = () => {
  ...
  const [selectedLinkAnimation, setSelectedLinkAnimation] = useState<
    "none" | "glow"
  >("none");
  ...
  // Persist current view to avoid resetting on remount
  useEffect(() => {
  ...
  useEffect(() => {
    sessionStorage.setItem("dashboard-view", currentView);
  }, [currentView]);
  ...
  const handleReorderLinks = async (event: DragEndEvent) => {
    ...
    try {
      ...
      await Promise.all(
        updates.map((u) =>
          updateLinkInDb(u.id, { position: u.position } as any)
        )
      );
    } catch (error) {
      ...
      try {
          ...
          setProfileConfig((prev) => ({
            ...
            avatar:
              profile.avatar_url && !profile.avatar_url.includes("unsplash.com")
                ? profile.avatar_url
                : "/assets/originalavatar.jpg",
            coverImage:
              profile.cover_image_url &&
              !profile.cover_image_url.includes("unsplash.com")
                ? profile.cover_image_url
                : "",
            plan: profile.plan,
        ...
        if (settings) {
          setProfileConfig((prev) => ({
            ...
            avatarFrame: (settings as any).avatar_frame || "classic",
            linkAnimation: settings.link_animation || "none",
          }));
          setSelectedLinkAnimation(settings.link_animation || "none");
          ...
          currentLinks.map((l) =>
            l.id === tempId
              ? {
                  ...
                  created_at: (created as any).created_at || nowIso,
                }
              : l
          )
        );
  ...
  const handleUpdateLink = async (
    id: string,
    updates: Partial<LinkItem> | { thumbnailFile: File }
  ) => {
    ...
    if ("thumbnail_url" in updates && (updates as any).thumbnail_url === null) {
      try {
        ...
        setLinks((prev) =>
          prev.map((l) =>
            l.id === id ? { ...l, thumbnail_url: undefined } : l
          )
        );
    ...
    if (
      "thumbnailFile" in updates &&
      (updates as any).thumbnailFile instanceof File
    ) {
      try {
        toast.loading("Uploading thumbnail...", { id: "link-thumb" });
        const url = await uploadImage(
          (updates as any).thumbnailFile,
          "links",
          user?.id || ""
        );
        if (url) {
          ...
          setLinks((prev) =>
            prev.map((l) => (l.id === id ? { ...l, thumbnail_url: url } : l))
          );
    ...
    setLinks((currentLinks) =>
      currentLinks.map((l) => (l.id === id ? { ...l, ...updates } : l))
    );
    ...
    debounceRef.current = setTimeout(async () => {
      try {
        const supabaseUpdates: Partial<SupabaseLink> = {
          ...(updates as Partial<SupabaseLink>),
        };
  ...
  const handleUpdateConfig = async (
    updates: Partial<ProfileConfig> | { avatar?: File; coverImage?: File }
  ) => {
    if (!user) return;
      ...
      try {
        ...
        if (url) {
          ...
          await updateAppearance(user.id, {
            theme: "custom",
            custom_theme_url: url,
          });
          toast.success("Custom theme updated");
        }
      } catch (e) {
        toast.error("Failed to upload theme image");
      }
      return;
    }
    ...
    if (
      "username" in cleanedUpdates &&
      typeof cleanedUpdates.username === "string"
    ) {
      cleanedUpdates.username = cleanedUpdates.username
        .toLowerCase()
        .replace(/\s+/g, "")
        .replace(/[^a-z0-9-_]/g, "");
    }
    ...
    setProfileConfig((prev) => ({
      ...prev,
      ...(cleanedUpdates as Partial<ProfileConfig>),
    }));
    ...
    Object.entries(cleanedUpdates).forEach(([key, val]) => {
      if (profileFields.includes(key)) {
        if (key === "coverImage")
          profileUpdates.cover_image_url = val as string;
        ...
        if (key === "buttonStyle") appearanceUpdates.button_style = val as any;
          ...
          appearanceUpdates.button_fill = val as any;
        else if (key === "buttonShadow")
          appearanceUpdates.button_shadow = val as any;
        else if (key === "customThemeUrl")
          appearanceUpdates.custom_theme_url = val as string;
        else if (key === "fontColor")
          appearanceUpdates.font_color = val as string;
        else if (key === "seoTitle")
          appearanceUpdates.seo_title = val as string;
        else if (key === "seoDescription")
          appearanceUpdates.seo_description = val as string;
        else if (key === "showBrandTag")
          appearanceUpdates.show_brand_tag = val as boolean;
        else if (key === "showUpdatedChip")
          (appearanceUpdates as any).show_updated_chip = val as boolean;
        else if (key === "avatarFrame")
          (appearanceUpdates as any).avatar_frame = val as string;
        else if (key === "linkAnimation")
          (appearanceUpdates as any).link_animation = val as string;
  ...
  const getSanitizedUsername = () => {
    return (profileConfig.username || "user")
      .toLowerCase()
      .replace(/\s+/g, "")
      .replace(/[^a-z0-9-_]/g, "");
  };
  ...
  const handleSaveContacts = () => {
    ...
    (
      ["phone", "email", "whatsapp", "linkedin"] as (keyof ContactInfo)[]
    ).forEach((key) => {
      ...
      case "appearance":
        return (
          <AppearanceView
            ...
            selectedLinkAnimation={selectedLinkAnimation}
            onSelectLinkAnimation={setSelectedLinkAnimation}
          />
        );
      case "analytics":
  ...
  return (
    <div className="min-h-screen bg-background text-primary flex">
      ...
      <aside className="w-64 border-r border-border hidden lg:flex flex-col p-6 fixed h-full bg-background z-20">
        ...
        <nav className="space-y-2 flex-1">
          <SidebarItem
            icon={Layers}
            label="Links"
            active={currentView === "links"}
            onClick={() => setCurrentView("links")}
          />
          <SidebarItem
            icon={Palette}
            label="Appearance"
            active={currentView === "appearance"}
        ...
        <div className="mt-auto pt-6 border-t border-border">
          {loading ? (
            ...
            <div
              ...
              className="flex items-center gap-3 px-2 group cursor-pointer hover:bg-surfaceHighlight p-2 rounded-xl transition-colors"
            >
              <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-blue-500 to-cyan-500 flex items-center justify-center text-white font-bold text-sm overflow-hidden">
                ...
                !profileConfig.avatar.includes("unsplash") ? (
                  <img
                  ...
                  profileConfig.username.charAt(0).toUpperCase()
                ) : (
                  "U"
                )}
              </div>
              <div className="flex-1 overflow-hidden">
                ...
                <p className="text-xs text-secondary truncate">
                  {profileConfig.plan
                    ? `${profileConfig.plan
                        .charAt(0)
                        .toUpperCase()}${profileConfig.plan.slice(1)} Plan`
                    : "Plan"}
                </p>
              </div>
          ...
          <div className="absolute left-0 top-0 h-full w-64 bg-surface border-r border-border p-6 flex flex-col animate-slide-right">
            ...
            <div className="border-t border-border pt-4 mt-auto">
              ...
              {loading ? (
                ...
                <div
                  onClick={handleLogout}
                  className="flex items-center gap-3 px-2 cursor-pointer group hover:bg-surfaceHighlight/50 p-2 rounded-xl transition-colors"
                >
                  <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-blue-500 to-cyan-500 flex items-center justify-center text-white font-bold text-sm overflow-hidden">
                    {profileConfig.avatar &&
                    !profileConfig.avatar.includes("unsplash") ? (
      ...
      <main className="flex-1 lg:ml-64 flex flex-col overflow-hidden h-screen bg-background/50 relative">
        ...
        <div
          ref={contentRef}
          className="flex-1 overflow-y-auto p-4 md:p-8 w-full scrollbar-hide"
        >
          {renderView()}
        </div>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
            <div className="bg-surface border border-border rounded-2xl w-full max-w-lg p-6 relative shadow-2xl animate-slide-up">
              ...
              <p className="text-secondary mb-6 text-sm">
                Add quick contact buttons that appear under your bio.
              </p>
                  ...
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <label className="inline-flex items-center gap-2 text-xs text-secondary">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleContactToggle("phone", e.target.checked)
                        }
                        aria-label="Toggle phone contact"
                      />
                      <div
                        className={`w-10 h-5 rounded-full border border-border relative transition-colors ${
                          contactToggles.phone
                            ? "bg-primary/80 border-primary/60"
                            : "bg-surfaceHighlight"
                        }`}
                      >
                        <div
                          className={`absolute top-[2px] left-[2px] h-4 w-4 rounded-full bg-background transition-transform ${
                            contactToggles.phone ? "translate-x-5" : ""
                          }`}
                        ></div>
                      </div>
                    </label>
                  ...
                  <div className="flex items-center justify-between mb-1.5">
                    ...
                    <label className="inline-flex items-center gap-2 text-xs text-secondary">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          handleContactToggle("email", e.target.checked)
                        }
                        aria-label="Toggle email contact"
                      />
                      <div
                        className={`w-10 h-5 rounded-full border border-border relative transition-colors ${
                          contactToggles.email
                            ? "bg-primary/80 border-primary/60"
                            : "bg-surfaceHighlight"
                        }`}
                      >
                        <div
                          className={`absolute top-[2px] left-[2px] h-4 w-4 rounded-full bg-background transition-transform ${
                            contactToggles.email ? "translate-x-5" : ""
                          }`}
                        ></div>
                      </div>
                    </label>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <label className="inline-flex items-center gap-2 text-xs text-secondary">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleContactToggle("whatsapp", e.target.checked)
                          }
                          aria-label="Toggle WhatsApp contact"
                        />
                        <div
                          className={`w-10 h-5 rounded-full border border-border relative transition-colors ${
                            contactToggles.whatsapp
                              ? "bg-primary/80 border-primary/60"
                              : "bg-surfaceHighlight"
                          }`}
                        >
                          <div
                            className={`absolute top-[2px] left-[2px] h-4 w-4 rounded-full bg-background transition-transform ${
                              contactToggles.whatsapp ? "translate-x-5" : ""
                            }`}
                          ></div>
                        </div>
                      </label>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1.5">
                      ...
                      <label className="inline-flex items-center gap-2 text-xs text-secondary">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            handleContactToggle("linkedin", e.target.checked)
                          }
                          aria-label="Toggle LinkedIn contact"
                        />
                        <div
                          className={`w-10 h-5 rounded-full border border-border relative transition-colors ${
                            contactToggles.linkedin
                              ? "bg-primary/80 border-primary/60"
                              : "bg-surfaceHighlight"
                          }`}
                        >
                          <div
                            className={`absolute top-[2px] left-[2px] h-4 w-4 rounded-full bg-background transition-transform ${
                              contactToggles.linkedin ? "translate-x-5" : ""
                            }`}
                          ></div>
                        </div>
                      </label>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleContactInputChange("linkedin", e.target.value)
                      }
